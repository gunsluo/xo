...
type Storage interface {
	...
	BooksByAuthorIDFK(db XODB, authorID int64, queryArgs *BookQueryArguments) ([]*Book, error)
	// CountBooksByAuthorIDFK count rows from books by foreign key AuthorID.
	// Generated from foreign key Author.
	CountBooksByAuthorIDFK(db XODB, authorID int64, queryArgs *BookQueryArguments) (int, error)
...
// Author represents a row from '"C##ADMIN"."authors"'.
type Author struct {
...
func (a *Author) Deleted() bool {
	return a._deleted
} // Book represents a row from '"C##ADMIN"."books"'.
type Book struct {
